...
return [
    'overview' => [
        ...
        'panel-background-helper' => 'Image URL, path, or "none" to disable. Leave blank to use the panel default.',
        'panel-background-reset' => 'Reset to Default',
        'panel-background-save' => 'Apply',
